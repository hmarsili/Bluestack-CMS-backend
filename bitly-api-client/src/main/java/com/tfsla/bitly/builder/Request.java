 ...
 */
package com.tfsla.bitly.builder;
...
import com.tfsla.bitly.BitlyClientException;
import com.tfsla.bitly.gson.GsonFactory;
import com.tfsla.bitly.model.Response;
import com.tfsla.bitly.model.ResponsePartial;
...
public abstract class Request<T> {
	...
	/** Logger */
	protected static final Log LOG = CmsLog.getLog(Request.class);
	...
	public Response<T> call() {
		try {
			...
			LOG.debug("Response received: {}" + resp);
