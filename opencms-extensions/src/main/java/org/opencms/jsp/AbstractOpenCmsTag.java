 ...
 * que est�n en el c�digo de OpenCMS
 * 
 * Por limitaciones de OpenCMS, al redefinir los m�todos release y endTag, deben llamar al super. 
 * 
 * @author lgassman
 */
public abstract class AbstractOpenCmsTag extends AbstractTag {
    ...
    /**
     * Devuelve el content o un String vac�o ("") si no existe
     * @return
     */
