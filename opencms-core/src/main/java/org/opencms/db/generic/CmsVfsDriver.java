...
public class CmsVfsDriver implements I_CmsDriver, I_CmsVfsDriver {
    ...
    protected org.opencms.db.generic.CmsSqlManager m_sqlMReadReplica;
    ...
    throws CmsDataAccessException {
        ...
        try {
            ...
            if (existingResource.getState().isDeleted()) {
                ...
                eventData.put(I_CmsEventListener.KEY_RESOURCE, existingResource);
    ...
    public void createSibling(CmsDbContext dbc, CmsProject project, CmsResource resource) throws CmsDataAccessException {
        ...
        try {
            ...
            if (existingSibling.getState().isDeleted()) {
                ...
                Map eventData = new HashMap();
                eventData.put(I_CmsEventListener.KEY_USER, dbc.getRequestContext().currentUser());
                eventData.put(I_CmsEventListener.KEY_RESOURCE, existingSibling);
    ...
    public CmsSqlManager getSqlReadManager() {

        return m_sqlMReadReplica;
    }
    ...
    public void init(
        ...
        String poolReplicaUrl = (String)configuration.get("db.vfs.replica.pool");
        if (poolReplicaUrl!=null) {
        	m_sqlMReadReplica = this.initSqlManager(classname);
        	m_sqlMReadReplica.init(I_CmsVfsDriver.DRIVER_TYPE_ID, poolReplicaUrl);
        }
        else
        {
        	m_sqlMReadReplica = m_sqlManager;
        }
        ...
        if (poolReplicaUrl!=null && CmsLog.INIT.isInfoEnabled()) {
        	CmsLog.INIT.info(Messages.get().getBundle().key(Messages.INIT_ASSIGNED_POOL_1, poolReplicaUrl));
        }
    ...
    public List readChildResources(
        ...
        if (getFolders && getFiles) {
            ...
            resourceTypeClause = m_sqlMReadReplica.readQuery(projectId, "C_RESOURCES_GET_SUBRESOURCES_GET_FOLDERS");
        } else {
            resourceTypeClause = m_sqlMReadReplica.readQuery(projectId, "C_RESOURCES_GET_SUBRESOURCES_GET_FILES");
        }
        StringBuffer query = new StringBuffer();
        query.append(m_sqlMReadReplica.readQuery(projectId, "C_RESOURCES_GET_SUBRESOURCES"));
        if (resourceTypeClause != null) {
            query.append(' ');
            query.append(resourceTypeClause);
        }

        String sizeColumn = m_sqlMReadReplica.readQuery("C_RESOURCES_SIZE");

        Connection conn = null;
        PreparedStatement stmt = null;
        ResultSet res = null;
        try {
            conn = m_sqlMReadReplica.getConnection(dbc);
            stmt = m_sqlMReadReplica.getPreparedStatementForSql(conn, query.toString());
            stmt.setString(1, resource.getStructureId().toString());
            res = stmt.executeQuery();
        	...
        	m_sqlMReadReplica.closeAll(dbc, conn, stmt, res);
        }
    ...
    public byte[] readContent(CmsDbContext dbc, CmsUUID projectId, CmsUUID resourceId) throws CmsDataAccessException {
        ...
        try {
            conn = m_sqlMReadReplica.getConnection(dbc);
            if (projectId.equals(CmsProject.ONLINE_PROJECT_ID)) {
                stmt = m_sqlMReadReplica.getPreparedStatement(conn, projectId, "C_ONLINE_FILES_CONTENT");
            } else {
                stmt = m_sqlMReadReplica.getPreparedStatement(conn, projectId, "C_OFFLINE_FILES_CONTENT");
            }
            stmt.setString(1, resourceId.toString());
            res = stmt.executeQuery();
            ...
            if (res.next()) {
                ...
                byteRes = m_sqlMReadReplica.getBytes(res, m_sqlMReadReplica.readQuery("C_RESOURCES_FILE_CONTENT"));
                while (res.next()) {
                    // do nothing only move through all rows because of mssql odbc driver
                }
            } else {
    ...
    public CmsFolder readFolder(CmsDbContext dbc, CmsUUID projectId, CmsUUID folderId) throws CmsDataAccessException {
        ...
        try {
            conn = m_sqlMReadReplica.getConnection(dbc);
            stmt = m_sqlMReadReplica.getPreparedStatement(conn, projectId, "C_RESOURCES_READBYID");
    ...
    public CmsFolder readFolder(CmsDbContext dbc, CmsUUID projectId, String folderPath) throws CmsDataAccessException {
        ...
        try {
            conn = m_sqlMReadReplica.getConnection(dbc);
            stmt = m_sqlMReadReplica.getPreparedStatement(conn, projectId, "C_RESOURCES_READ");
    ...
    throws CmsDataAccessException {
        ...
        try {
            conn = m_sqlMReadReplica.getConnection(dbc);
            stmt = m_sqlMReadReplica.getPreparedStatement(conn, projectId, "C_RESOURCES_READ_PARENT_BY_ID");
    ...
    throws CmsDataAccessException {
        ...
        try {
            conn = m_sqlMReadReplica.getConnection(dbc);
            stmt = m_sqlMReadReplica.getPreparedStatement(conn, projectId, "C_PROPERTYDEF_READ");
            ...
            if (res.next()) {
                propDef = new CmsPropertyDefinition(
                    new CmsUUID(res.getString(m_sqlMReadReplica.readQuery("C_PROPERTYDEF_ID"))),
                    res.getString(m_sqlMReadReplica.readQuery("C_PROPERTYDEF_NAME")),
                    CmsPropertyDefinition.CmsPropertyType.valueOf(res.getInt(m_sqlMReadReplica.readQuery("C_PROPERTYDEF_TYPE"))));
                while (res.next()) {
                    // do nothing only move through all rows because of mssql odbc driver
                }
            } else {
    ...
    public List readPropertyDefinitions(CmsDbContext dbc, CmsUUID projectId) throws CmsDataAccessException {
        ...
        try {
            conn = m_sqlMReadReplica.getConnection(dbc);
            stmt = m_sqlMReadReplica.getPreparedStatement(conn, projectId, "C_PROPERTYDEF_READALL");
    ...
    throws CmsDataAccessException {
        ...
        try {
            conn = m_sqlMReadReplica.getConnection(dbc);
            stmt = m_sqlMReadReplica.getPreparedStatement(conn, projectId, "C_PROPERTIES_READ");
    ...
    throws CmsDataAccessException {
        ...
        try {
            conn = m_sqlMReadReplica.getConnection(dbc);
            stmt = m_sqlMReadReplica.getPreparedStatement(conn, projectId, "C_PROPERTIES_READALL");
            stmt.setString(1, resource.getStructureId().toString());
            stmt.setString(2, resource.getResourceId().toString());
            res = stmt.executeQuery();
    ...
    throws CmsDataAccessException {
        ...
        try {
            ...
            if (filter.isSource()) {
                ...
                StringBuffer queryBuf = new StringBuffer(256);
                queryBuf.append(m_sqlMReadReplica.readQuery(projectId, "C_READ_RELATIONS"));
                queryBuf.append(prepareRelationConditions(projectId, filter, resource, params, true));
                if (LOG.isDebugEnabled()) {
                    LOG.debug(queryBuf.toString());
                }

                stmt = m_sqlMReadReplica.getPreparedStatementForSql(conn, queryBuf.toString());
                for (int i = 0; i < params.size(); i++) {
                    if (params.get(i) instanceof Integer) {
                        stmt.setInt(i + 1, ((Integer)params.get(i)).intValue());
                    } else {
                ...
                m_sqlMReadReplica.closeAll(dbc, null, stmt, res);
            }
    ...
    throws CmsDataAccessException {
        ...
        try {
            ...
            if (mode == CmsDriverManager.READMODE_MATCHSTATE) {
                stmt = m_sqlMReadReplica.getPreparedStatement(
                    conn,
                    projectId,
    ...
    throws CmsDataAccessException {
        ...
        try {
            conn = m_sqlMReadReplica.getConnection(dbc);
            stmt = m_sqlMReadReplica.getPreparedStatement(conn, project, "C_SELECT_RESOURCES_FOR_PRINCIPAL_ACE");
    ...
    throws CmsDataAccessException {
        ...
        try {
            conn = m_sqlMReadReplica.getConnection(dbc);
            stmt = m_sqlMReadReplica.getPreparedStatement(conn, project, "C_SELECT_RESOURCES_FOR_PRINCIPAL_ATTR");
    ...
    public List readResourcesWithProperty(
        ...
        try {
            conn = m_sqlMReadReplica.getConnection(dbc);
            if (value == null) {
                stmt = m_sqlMReadReplica.getPreparedStatement(conn, projectId, "C_RESOURCES_GET_RESOURCE_WITH_PROPERTYDEF");
    ...
    protected String getLimitClause(Integer size,
            Integer offset) {
    	String limit="";
        if (size!=null) {
        	limit = "limit ";
    ...
    public List readResourceTree(
        ...
        int mode,
        Integer size,
        Integer offset) throws CmsDataAccessException {
        ...
        String limit = getLimitClause(size,offset);
        ...
        try {
            conn = m_sqlMReadReplica.getConnection(dbc);
            StringBuffer queryBuf = new StringBuffer(256);
            queryBuf.append(m_sqlMReadReplica.readQuery(projectId, "C_RESOURCES_READ_TREE"));
            queryBuf.append(conditions);
            queryBuf.append(" ");
            queryBuf.append(m_sqlMReadReplica.readQuery(projectId, "C_RESOURCES_ORDER_BY_PATH"));
            queryBuf.append(" ");
    ...
    throws CmsDataAccessException {
        ...
        try {
            ...
            if (includeDeleted) {
                stmt = m_sqlMReadReplica.getPreparedStatement(conn, projectId, "C_SELECT_VFS_SIBLINGS");
            } else {
                stmt = m_sqlMReadReplica.getPreparedStatement(conn, projectId, "C_SELECT_NONDELETED_VFS_SIBLINGS");
            }
    ...
    throws CmsDataAccessException {
        ...
        try {
            ...
            stmt = m_sqlMReadReplica.getPreparedStatement(conn, projectId, "C_RESOURCES_READ_VERSION_RES");
            stmt.setString(1, resourceId.toString());
            res = stmt.executeQuery();
            if (res.next()) {
                resourceVersion = res.getInt(m_sqlMReadReplica.readQuery("C_RESOURCES_VERSION"));
                while (res.next()) {
                    // do nothing only move through all rows because of mssql odbc driver
                }
            }
            ...
            stmt = m_sqlMReadReplica.getPreparedStatement(conn, projectId, "C_RESOURCES_READ_VERSION_STR");
            stmt.setString(1, structureId.toString());
            res = stmt.executeQuery();
            if (res.next()) {
                structureVersion = res.getInt(m_sqlMReadReplica.readQuery("C_RESOURCES_STRUCTURE_VERSION"));
                while (res.next()) {
                    // do nothing only move through all rows because of mssql odbc driver
                }
            }
    ...
    /**
     * Sets the driver manager for this driver.<p>
     * 
    ...
    /**
     * Sets the SQL manager of this driver.<p>
     * 
    ...
    throws CmsDataAccessException {
        ...
        try {
            conn = m_sqlMReadReplica.getConnection(dbc);
            stmt = m_sqlMReadReplica.getPreparedStatement(conn, projectId, "C_RESOURCES_READ_RESOURCE_STATE");
            stmt.setString(1, resourceId.toString());
    ...
    throws CmsDataAccessException {
        ...
        try {
            conn = m_sqlMReadReplica.getConnection(dbc);
            stmt = m_sqlMReadReplica.getPreparedStatement(conn, projectId, "C_RESOURCES_SELECT_STRUCTURE_ID");
            stmt.setString(1, structureId.toString());
    ...
    protected void checkWritePermissionsInFolder(CmsDbContext dbc, CmsResource folder) throws CmsDataAccessException {
        ...
        try {
            conn = m_sqlMReadReplica.getConnection(dbc);
            stmt = m_sqlMReadReplica.getPreparedStatement(conn, projectId, "C_RESOURCES_READ_WITH_ACE_1");
     ...
     */
    protected List<CmsOrganizationalUnit> getResourceOus(CmsDbContext dbc, CmsUUID projectId, CmsResource resource)
    throws CmsDbSqlException {
        ...
        try {
            conn = m_sqlMReadReplica.getConnection(dbc);
            stmt = m_sqlMReadReplica.getPreparedStatementForSql(conn, m_sqlMReadReplica.readQuery(
                projectId,
                "C_READ_RESOURCE_OUS"));
    ...
    throws CmsDataAccessException {
        ...
        try {
            // create statement
            conn = m_sqlMReadReplica.getConnection(dbc);
            stmt = m_sqlMReadReplica.getPreparedStatement(conn, projectId, "C_PROPERTIES_READALL_COUNT");
            stmt.setString(1, propertyDefinition.getId().toString());
            res = stmt.executeQuery();
    ...
    throws CmsDataAccessException {
        ...
        try {
            conn = m_sqlMReadReplica.getConnection(dbc);
            stmt = m_sqlMReadReplica.getPreparedStatement(conn, projectId, "C_RESOURCES_READ_PARENT_STRUCTURE_ID");
    ...
    protected CmsRelation internalReadRelation(ResultSet res) throws SQLException {
        ...
        CmsUUID sourceId = new CmsUUID(res.getString(m_sqlMReadReplica.readQuery("C_RELATION_SOURCE_ID")));
        String sourcePath = res.getString(m_sqlMReadReplica.readQuery("C_RELATION_SOURCE_PATH"));
        CmsUUID targetId = new CmsUUID(res.getString(m_sqlMReadReplica.readQuery("C_RELATION_TARGET_ID")));
        String targetPath = res.getString(m_sqlMReadReplica.readQuery("C_RELATION_TARGET_PATH"));
        int type = res.getInt(m_sqlMReadReplica.readQuery("C_RELATION_TYPE"));
    ...
    throws CmsDbSqlException {
        ...
        try {
            conn = m_sqlMReadReplica.getConnection(dbc);
            stmt = m_sqlMReadReplica.getPreparedStatement(conn, projectId, "C_READ_RESOURCE_STATE");
            stmt.setString(1, resource.getResourceId().toString());
            res = stmt.executeQuery();
            if (res.next()) {
                state = CmsResourceState.valueOf(res.getInt(m_sqlMReadReplica.readQuery("C_RESOURCES_STATE")));
                while (res.next()) {
                    // do nothing only move through all rows because of mssql odbc driver
                }
            }
    ...
    throws CmsDbSqlException {
        ...
        try {
            conn = m_sqlMReadReplica.getConnection(dbc);
            stmt = m_sqlMReadReplica.getPreparedStatement(conn, projectId, "C_READ_STRUCTURE_STATE");
            stmt.setString(1, resource.getStructureId().toString());
            res = stmt.executeQuery();
            if (res.next()) {
                state = CmsResourceState.valueOf(res.getInt(m_sqlMReadReplica.readQuery("C_RESOURCES_STRUCTURE_STATE")));
                while (res.next()) {
                    // do nothing only move through all rows because of mssql odbc driver
                }
            }
	...
	public List readResourcesWithProperty(
        ...
        try {
            conn = m_sqlManager.getConnection(dbc);
            if (value == null) {
                stmt = m_sqlManager.getPreparedStatement(conn, projectId, "C_RESOURCES_GET_RESOURCE_WITH_PROPERTYDEF_OFFSET");
                stmt.setString(1, propertyDef.toString());
                stmt.setString(2, path + "%");
                stmt.setString(3, propertyDef.toString());
                stmt.setString(4, path + "%");
                ...
                stmt = m_sqlManager.getPreparedStatement(
                    conn,
                    projectId,
                    "C_RESOURCES_GET_RESOURCE_WITH_PROPERTYDEF_VALUE_OFFSET");
                stmt.setString(1, propertyDef.toString());
                stmt.setString(2, path + "%");
                stmt.setString(3, "%" + value + "%");
                stmt.setString(4, propertyDef.toString());
