...
public class CmsUserDriver implements I_CmsDriver, I_CmsUserDriver {
    ...
    public CmsUser createUser(
        ...
        try {
            ...
            stmt.setLong(11, Long.MIN_VALUE);  //last password changed.
    ...
    public void deleteTwoFactor(CmsDbContext dbc, CmsUUID userId) 
    		throws CmsDataAccessException {
        ...
        try {
            conn = getSqlManager().getConnection(dbc);
            stmt = m_sqlManager.getPreparedStatement(conn, "C_DELETE_USER_SECRET_TWOFACTOR");
    ...
    throws CmsDataAccessException {
        ...
        try {
            ...
            Iterator itResources = m_driverManager.readResources(
                ...
                parentFolder,
                CmsResourceFilter.DEFAULT,
                includeChildren, null, null).iterator();
    ...
    public void updateExternalProvider(CmsDbContext dbc, CmsUserExternalProvider externalProvider) throws CmsDataAccessException {
        PreparedStatement stmt = null;
        Connection conn = null;
            try {
                conn = getSqlManager().getConnection(dbc);
                stmt = m_sqlManager.getPreparedStatement(conn, "C_UPDATE_USER_EXTERNAL_PROVIDER");
                stmt.setString(1, externalProvider.getToken());
                stmt.setString(2, externalProvider.getId().getStringValue());
                stmt.executeUpdate();
    ...
    public void createExternalProvider(CmsDbContext dbc, CmsUserExternalProvider externalProvider) throws CmsDataAccessException {
        PreparedStatement stmt = null;
        Connection conn = null;
            try {
                conn = getSqlManager().getConnection(dbc);
                stmt = m_sqlManager.getPreparedStatement(conn, "C_WRITE_USER_EXTERNAL_PROVIDER");
                stmt.setString(1, externalProvider.getId().getStringValue());
                stmt.setString(2, CmsOrganizationalUnit.getSimpleName(externalProvider.getName())); 
                stmt.setString(3, CmsOrganizationalUnit.SEPARATOR + CmsOrganizationalUnit.getParentFqn(externalProvider.getName()));
                stmt.setString(4, externalProvider.getProvider());
                stmt.setString(5, externalProvider.getProviderUserId() );
                stmt.setString(6, externalProvider.getToken());
                stmt.executeUpdate();
    ...
    public CmsUserExternalProvider readExternalUserProvider(CmsDbContext dbc, String providerName, String id) throws CmsDataAccessException {
        PreparedStatement stmt = null;
        ResultSet res = null;
        CmsUserExternalProvider userExternalProvider = null;
        Connection conn = null;
        try {
            conn = m_sqlManager.getConnection(dbc);
            stmt = m_sqlManager.getPreparedStatement(conn, "C_READ_USER_EXTERNAL_PROVIDER");
            ...
            if (res.next()) {
            	userExternalProvider = internalCreateUserExternalProvider(dbc, res);
                while (res.next()) {
                    // do nothing only move through all rows because of mssql odbc driver
                }
            } else {
    ...
    public CmsUserTwoFactor readTwoFactorByTemp(CmsDbContext dbc, String temp) 
    throws CmsDataAccessException {
        PreparedStatement stmt = null;
        ResultSet res = null;
        CmsUserTwoFactor userTwoFactor = null;
        Connection conn = null;
        try {
            conn = m_sqlManager.getConnection(dbc);
            stmt = m_sqlManager.getPreparedStatement(conn, "C_SELECT_USER_TWOFACTOR_BYTEMP");
            stmt.setString(1, temp);
            
            res = stmt.executeQuery();
            
            if (res.next()) {
            	userTwoFactor = internalCreateTwoFactor(dbc, res);
                while (res.next()) {
                    // do nothing only move through all rows because of mssql odbc driver
                }
            } else {
                CmsMessageContainer message = org.opencms.db.Messages.get().container(
                    org.opencms.db.Messages.ERR_UNKNOWN_TWOFACTOR_1,
                    temp);
                if (LOG.isDebugEnabled()) {
                    LOG.debug(message.key());
                }
    ...
    public CmsUserTwoFactor readTwoFactor(CmsDbContext dbc, CmsUUID id) 
    throws CmsDataAccessException {
        PreparedStatement stmt = null;
        ResultSet res = null;
        CmsUserTwoFactor userTwoFactor = null;
        ...
        try {
            conn = m_sqlManager.getConnection(dbc);
            stmt = m_sqlManager.getPreparedStatement(conn, "C_SELECT_USER_TWOFACTOR");
            stmt.setString(1, id.toString());
    ...
    /**
     * Sets the SQL manager for this driver.<p>
     * 
    ...
    throws CmsDataAccessException, CmsPasswordEncryptionException {
        ...
        try {
            ...
            stmt.setString(3, CmsOrganizationalUnit.getSimpleName(userFqn));
            stmt.setString(4, CmsOrganizationalUnit.SEPARATOR + CmsOrganizationalUnit.getParentFqn(userFqn));
            
            //System.err.println("actualizando password: " + stmt.toString());
            stmt.executeUpdate();
        } catch (SQLException e) {
            throw new CmsDbSqlException(Messages.get().container(
                Messages.ERR_GENERIC_SQL_1,
    ...
    public void updateTwoFactor(CmsDbContext dbc, CmsUserTwoFactor twoFactor)  
    		throws CmsDataAccessException {
    	        ...
    	        try {
    	            conn = getSqlManager().getConnection(dbc);
    	            stmt = m_sqlManager.getPreparedStatement(conn, "C_UPDATE_USER_TWOFACTOR");
    	            stmt.setString(1, twoFactor.getSecret());
    	            stmt.setLong(2, twoFactor.getCounter());
    	            stmt.setLong(3, twoFactor.getLastmodified());
    	            stmt.setString(4, twoFactor.getTemporalToken());
    	            stmt.setString(5, twoFactor.getUniqueCodes());
    	            stmt.setString(6, twoFactor.getId().toString());
    ...
    public void writeTwoFactor(CmsDbContext dbc, CmsUserTwoFactor twoFactor)  throws CmsDataAccessException {
        ...
        try {
            conn = getSqlManager().getConnection(dbc);
            stmt = m_sqlManager.getPreparedStatement(conn, "C_INSERT_USER_TWOFACTOR");
            
            // write data to database
            stmt.setString(1, twoFactor.getId().toString());
            stmt.setString(2, twoFactor.getSecret());
            stmt.setLong(3, twoFactor.getCounter());
            stmt.setLong(4, twoFactor.getLastmodified());
            stmt.setString(5, twoFactor.getTemporalToken());
            stmt.setString(6, twoFactor.getUniqueCodes());
            
            stmt.executeUpdate();
        } catch (SQLException e) {
       	 LOG.error("writeTwoFactor: " + stmt.toString(),e);
            throw new CmsDbSqlException(Messages.get().container(
                Messages.ERR_GENERIC_SQL_1,
                CmsDbSqlException.getErrorQuery(stmt)), e);
        } finally {
    ...
    public void writeUser(CmsDbContext dbc, CmsUser user) throws CmsDataAccessException {
        ...
        if (CmsStringUtil.isNotEmpty(att_login)) {
            ...
            try {
                ...
                //System.out.println(CmsDbSqlException.getErrorQuery(stmt));
            } catch (SQLException e) {
            	e.printStackTrace();
                throw new CmsDbSqlException(Messages.get().container(
                    Messages.ERR_GENERIC_SQL_1,
            ...
            try {
                ...
                stmt.setLong(6, user.getLastPasswordChanged());
    ...
    protected CmsUserTwoFactor internalCreateTwoFactor(CmsDbContext dbc, ResultSet res) throws CmsDataAccessException, SQLException {
        CmsUUID userId = new CmsUUID(res.getString(m_sqlManager.readQuery("C_TWOFACTOR_USER_ID_0")));
        
        if (LOG.isDebugEnabled()) {
            LOG.debug(Messages.get().getBundle().key(Messages.LOG_DBG_CREATE_TWOFACTOR_1, userId.toString()));
        }
        

        //(CmsUUID id, long lastmodified, String secret, int counter)
        return new CmsUserTwoFactor(
                userId,
                res.getLong(m_sqlManager.readQuery("C_TWOFACTOR_LAST_MODIFIED_0")),
                res.getString(m_sqlManager.readQuery("C_TWOFACTOR_SECRET_0")),
                res.getLong(m_sqlManager.readQuery("C_TWOFACTOR_COUNTER_0")),
                res.getString(m_sqlManager.readQuery("C_TWOFACTOR_TEMPORALTOKEN_0")),
                res.getString(m_sqlManager.readQuery("C_TWOFACTOR_UNIQUE_CODES_0"))
               );
    ...
    protected CmsUserExternalProvider internalCreateUserExternalProvider (CmsDbContext dbc, ResultSet res) throws CmsDataAccessException, SQLException {
    	
    	String userName = res.getString(m_sqlManager.readQuery("C_USER_EXTERNAL_PROVIDER_NAME_0"));
        String ou = CmsOrganizationalUnit.removeLeadingSeparator(res.getString(m_sqlManager.readQuery("C_USER_EXTERNAL_PROVIDER_OU_0")));
        CmsUUID userId = new CmsUUID(res.getString(m_sqlManager.readQuery("C_USER_EXTERNAL_PROVIDER_ID_0")));

        if (LOG.isDebugEnabled()) {
            LOG.debug(Messages.get().getBundle().key(Messages.LOG_DBG_CREATE_USER_1, userName));
        }

        return new CmsUserExternalProvider(
            userId,
            ou + userName,
            res.getString(m_sqlManager.readQuery("C_USER_EXTERNAL_PROVIDER_PROVIDER_0")),
            res.getString(m_sqlManager.readQuery("C_USER_EXTERNAL_PROVIDER_PROV_ID_0")),
            res.getString(m_sqlManager.readQuery("C_USER_EXTERNAL_PROVIDER_TOKEN_0")));
    }
    ...
    protected CmsUser internalCreateUser(CmsDbContext dbc, ResultSet res) throws CmsDataAccessException, SQLException {
        ...
        return new CmsUser(
            ...
            res.getLong(m_sqlManager.readQuery("C_USER_LASTPASSCHANGE_0")),
            null);
    }
    ...
    protected void internalDeleteOrgUnitResource(CmsDbContext dbc, CmsResource resource) throws CmsException {
        ...
        eventData.put(I_CmsEventListener.KEY_RESOURCES, resource);
     
        
        OpenCms.fireCmsEvent(new CmsEvent(I_CmsEventListener.EVENT_RESOURCE_DELETED, eventData));
     
        Map eventDataModifiedEvent = new HashMap();
        eventDataModifiedEvent.put(I_CmsEventListener.KEY_USER, dbc.getRequestContext().currentUser());
        eventDataModifiedEvent.put(I_CmsEventListener.KEY_RESOURCE, resource);
     
        
        OpenCms.fireCmsEvent(new CmsEvent(
            I_CmsEventListener.EVENT_RESOURCE_AND_PROPERTIES_MODIFIED, eventDataModifiedEvent));
