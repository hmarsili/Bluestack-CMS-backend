...
public interface I_CmsUserDriver extends I_CmsDriver {
    ...
    CmsUserExternalProvider readExternalUserProvider(CmsDbContext dbc, String providerName, String id) throws CmsDataAccessException;
    ...
    public CmsUserTwoFactor readTwoFactorByTemp(CmsDbContext dbc, String tempId) 
    	    throws CmsDataAccessException;
