...
public final class Messages extends A_CmsMessageBundle {
    ...
    /** Message constant for key in the resource bundle. */
    public static final String ERR_INVALID_LOGIN_DATA_1 = "ERR_INVALID_LOGIN_DATA_1";
    
    /** Message constant for key in the resource bundle. */
    public static final String ERR_OLD_LOGIN_DATA_1 = "ERR_OLD_LOGIN_DATA_1";
    
    /** Message constant for key in the resource bundle. */
    public static final String ERR_UNKNOWN_TOKEN_1 = "ERR_UNKNOWN_TOKEN_1";
    
    /** Message constant for key in the resource bundle. */
    public static final String ERR_UNKNOWN_TWOFACTOR_1 = "ERR_UNKNOWN_TWOFACTOR_1";

    /** Message constant for key in the resource bundle. */
    public static final String ERR_UNKNOWN_TWOFACTOR_2 = "ERR_UNKNOWN_TWOFACTOR_2";
    
    /** Message constant for key in the resource bundle. */
    public static final String ERR_UNKNOWN_EXTERNALUSER_1 = "ERR_UNKNOWN_EXTERNALUSER_1";
    
    /** Message constant for key in the resource bundle. */
	public static final String ERR_PURGE_TOKEN_1 = "ERR_PURGE_TOKEN_1";

	/** Message constant for key in the resource bundle. */
	public static final String ERR_2FA_RECREATE_1 = "ERR_2FA_RECREATE_1";
	
	/** Message constant for key in the resource bundle. */
	public static final String ERR_2FA_CREATECODE_1 = "ERR_2FA_CREATECODE_1";

	/** Message constant for key in the resource bundle. */
	public static final String ERR_2FA_GETQRCODE_1 = "ERR_2FA_GETQRCODE_1";
	
	/** Message constant for key in the resource bundle. */
	public static final String ERR_2FA_VALIDATE_1 = "ERR_2FA_VALIDATE_1";

	/** Message constant for key in the resource bundle. */
	public static final String ERR_2FA_VALIDATE_2 = "ERR_2FA_VALIDATE_2";
	
	/** Message constant for key in the resource bundle. */
	public static final String ERR_2FA_INVALIDTEMP_1 = "ERR_2FA_INVALIDTEMP_1";
    ...
    /** Message constant for key in the resource bundle. */
    public static final String ERR_WRITE_TOKEN_1 = "ERR_WRITE_TOKEN_1";
