...
public final class CmsRequestUtil {
    ...
    /** The Header that stores the user token. */
    public static final String HEADER_USER_TOKENID = "USER_TOKEN";
    /** The Header that stores the browserId. */
    public static final String HEADER_BROWSER_ID = "BROWSER_ID";
    /** The Header that stores the project. */
    public static final String HEADER_PROJECT = "PROJECT";
    /** The Header that stores the site. */
