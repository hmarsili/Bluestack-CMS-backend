...
public class CmsSearchParameters {
    ...
    private boolean m_expiredContent;
    ...
    public boolean isExpiredContentIncluded() {
    	return  m_expiredContent;
    }
    /**
    ...
    public void setExpiredContentIncluded(boolean expiredContent) {
    	m_expiredContent = expiredContent;
    }
