...
public class CmsIndexingThread extends Thread {
    ...
    private java.util.Date extractedTime = null;
     
    private Document m_result=null;
    ...
    public void logStatus() {
    	...
    	if (LOG.isWarnEnabled()) {
    		...
    		String status = 
	            ...
	            " extractedTime: " + (extractedTime != null ? extractedTime.toString() : " - ");
	            
    		LOG.warn(Messages.get().getBundle().key(
                    Messages.LOG_IO_INDEX_WRITER_WRITE_TIMEOUT_1,
                    m_res.getRootPath(),
                    m_index.getName(),
                    status)
    				);
    ...
    public void run() {
        ...
        try {
            ...
            m_result =  m_documentType.createDocument(m_cms, m_res, m_index);
            extractedTime = new java.util.Date();
            ...
            if (!isInterrupted()) {
                ...
                indexedTime = new java.util.Date();
            }
             */
