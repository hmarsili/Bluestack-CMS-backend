...
public class CmsSearchResult implements I_CmsMemoryMonitorable, Comparable<CmsSearchResult> {
     ...
     */
    public CmsSearchResult(int score, float luceneScore, Document doc, String excerpt) {

        m_score = score;
        m_luceneScore = luceneScore;
        m_excerpt = excerpt;
