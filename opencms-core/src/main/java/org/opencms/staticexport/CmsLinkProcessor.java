...
public class CmsLinkProcessor extends CmsHtmlParser {
    ...
    public static final String ATTRIBUTE_DATA_SRC = "data-src";
    ...
    protected void processSpanTag(Span tag) {

        processLink(tag, ATTRIBUTE_DATA_SRC, CmsRelationType.EMBEDDED_IMAGE);
    }
