...
public class CmsPropertyDefinition implements Cloneable, Comparable {
    ...
    /** Property constant for Focal point. */
    public static final String PROPERTY_FOCALPOINT = "image.focalPoint";
    ...
    /** Property constant for <code>"image.size.width"</code>. */
    public static final String PROPERTY_IMAGE_DIMENSION_WIDTH = "image.size.width";
    
    /** Property constant for <code>"image.size.total"</code>. */
    public static final String PROPERTY_IMAGE_DIMENSION_TOTAL = "image.size.total";
