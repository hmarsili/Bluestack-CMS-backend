...
public class CmsUser extends CmsPrincipal implements Cloneable {
    ...
    private long m_lastPasswordChanged;
     ...
     * @param lastPasswordChanged the last time the password was changed
    ...
    public CmsUser(
        ...
        m_lastPasswordChanged = lastPasswordChanged;
    ...
    public boolean mustChangePassword() {
    	return (m_lastPasswordChanged==Long.MIN_VALUE);
    }
    
    public long getLastPasswordChanged() {
    	return m_lastPasswordChanged;
    }
    ...
    public void setLastPasswordChanged(long value) {
    	m_lastPasswordChanged = value;
    }
