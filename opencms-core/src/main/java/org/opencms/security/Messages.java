...
public final class Messages extends A_CmsMessageBundle {
    ...
    /** Message constant for key in the resource bundle. */
    public static final String ERR_LOGIN_FAILED_TIMEOUT_1 = "ERR_LOGIN_FAILED_TIMEOUT_1";
    
    /** Message constant for key in the resource bundle. */
    public static final String ERR_LOGIN_TWOFACTOR_CONFIGURATION_1 = "ERR_LOGIN_TWOFACTOR_CONFIGURATION_1";
    
    /** Message constant for key in the resource bundle. */
    public static final String ERR_LOGIN_FAILED_CODE_INVALID_1 = "ERR_LOGIN_FAILED_CODE_INVALID_1";
      
    /** Message constant for key in the resource bundle. */
    public static final String ERR_LOGIN_FAILED_DISABLED_2 = "ERR_LOGIN_FAILED_DISABLED_2";

    /** Message constant for key in the resource bundle. */
    public static final String ERR_LOGIN_FAILED_TOKEN_INVALIDAD_1 = "ERR_LOGIN_FAILED_TOKEN_INVALIDAD_1";

    /** Message constant for key in the resource bundle. */
    public static final String ERR_LOGIN_FAILED_TOKEN_EXPIRED_1 = "ERR_LOGIN_FAILED_TOKEN_EXPIRED_1";
