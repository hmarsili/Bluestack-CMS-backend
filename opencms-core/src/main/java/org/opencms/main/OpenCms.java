...
public final class OpenCms {
    ...
    public static CmsTwoFactorLoginConfiguration getCmsTwoFactorLoginConfiguration() {
    	return OpenCmsCore.getInstance().getCmsTwoFactorLoginConfiguration();
    }
    /**
     ...
     * @return the validation handler
     */
    public static I_CmsTokenEncryptationHandler getTokenEncryptationHandler() {

        return OpenCmsCore.getInstance().getTokenEncryptationHandler();
    }
