...
public interface I_CmsEventListener {
    ...
    int EVENT_BEFORE_RESOURCE_DELETED = 33;
    ...
    /** Key name for direct publish resource. */
    String KEY_DIRECTPUBLISH = "directPublish";
    ...
    /** Key for passing a cmsObject */
    String KEY_CMS_OBJECT = "cmsObject";
    
    /** Key for passing an user */
    String KEY_USER = "cmsUser";
