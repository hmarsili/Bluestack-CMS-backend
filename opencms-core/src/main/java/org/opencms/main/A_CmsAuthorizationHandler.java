...
public abstract class A_CmsAuthorizationHandler implements I_CmsAuthorizationHandler {
    ...
    protected CmsObject initCmsObjectFromHeader(HttpServletRequest request) throws CmsException {

        // try to get an OpenCms user session info object for this request
        return OpenCmsCore.getInstance().initCmsObjectFromHeader(request);
    }
