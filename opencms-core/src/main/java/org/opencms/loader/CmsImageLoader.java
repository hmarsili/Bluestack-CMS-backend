...
public class CmsImageLoader extends CmsDumpLoader implements I_CmsEventListener {
    ...
    public static CmsVfsNameBasedDiskCache getVfsNameBasedDiskCache() {
    	return m_vfsDiskCache;
    }
    ...
    throws IOException, CmsException {
        ...
        if (m_enabled) {
            ...
            CmsImageScaler scaler = new CmsImageScaler(req, m_maxScaleSize, m_maxBlurSize,cms,resource);
