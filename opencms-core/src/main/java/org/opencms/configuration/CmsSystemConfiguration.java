...
import org.opencms.db.CmsTwoFactorLoginConfiguration;
...
import org.opencms.security.CmsDefaultTokenEncryptationHandler;
...
public class CmsSystemConfiguration extends A_CmsXmlConfiguration {
    ...
    /** The node name for the onetimepassword expression. */
    public static final String N_ONETIMEPASSWORD = "onetimepassword";
    
    /** The node name for the tokenEncryptationhandler expression. */
    public static final String N_TOKENENCRYPTATIONHANDLER = "tokenEncryptationhandler";

    /** The node name for the hotp-enabled expression. */
    public static final String N_HOTPENABLED = "hotp-enabled";

    /** The node name for the totp-enabled expression. */
    public static final String N_TOTPENABLED = "totp-enabled";
    
    /** The node name for the totp-enabled expression. */
    public static final String N_OTCENABLED = "otc-enabled";

    /** The node name for the hopt-digits expression. */
    public static final String N_HOTPDIGITS = "hotp-digits";

    /** The node name for the topt-digits expression. */
    public static final String N_TOTPDIGITS = "totp-digits";

    /** The node name for the topt-duration expression. */
    public static final String N_TOTPDURATION = "totp-duration";
    
    /** The node name for the hopt-validtime expression. */
    public static final String N_HOTPVALIDTIME = "hotp-validtime";

    /** The node name for the topt-label expression. */
    public static final String N_TOTPLABEL = "totp-label";

    /** The node name for the opt-algorithm expression. */
    public static final String N_OTPTALGORITHM = "otp-algorithm";

    /** The node name for the sms-hotpsendenabled expression. */
    public static final String N_SMSHOTPSENDENABLED = "sms-hotpsendenabled";

    /** The node name for the email-Hotpsendenabled expression. */
    public static final String N_EMAILHOTPSENDENABLED = "email-hotpsendenabled";

    /** The node name for the sms-endpoint expression. */
    public static final String N_SMSENDPOINT = "sms-endpoint";

    /** The node name for the rsa-publickey-token expression. */
    public static final String N_RSAPUKTOKEN = "rsa-publickey-token";

    /** The node name for the rsa-privatekey-token expression. */
    public static final String N_RSAPRKTOKEN = "rsa-privatekey-token";

    /** The node name for the rsa-key-channel expression. */
    public static final String N_RSAKEYEXTCHANNEL = "rsa-key-channel";
    
    /** The node name for the token-duration expression. */
    public static final String N_TOKENDURATION = "token-duration";
    ...
    /** The configured OpenCms default users and groups. */
    private CmsTwoFactorLoginConfiguration m_cmsTwoFactorLoginConfiguration;
    ...
    /** The configured token encryptation handler. */
    private String m_tokenEncryptationHandler;
    ...
    public void addXmlDigesterRules(Digester digester) {
        ...
        //FIN: ESTO NO SE SI DEJARLO O SACARLO!!!!!!!!!!!!!
        ...
        // add token encryptation handler creation rules
        digester.addCallMethod("*/" + N_SYSTEM + "/" + N_TOKENENCRYPTATIONHANDLER, "setTokenEncryptationHandler", 1);
        digester.addCallParam("*/" + N_SYSTEM + "/" + N_TOKENENCRYPTATIONHANDLER, 0, A_CLASS);
        ...
        // add one time password configuration
        digester.addCallMethod("*/" + N_SYSTEM + "/" + N_ONETIMEPASSWORD, "setCmsTwoFactorLoginConfiguration", 16);
        digester.addCallParam("*/" + N_SYSTEM + "/" + N_ONETIMEPASSWORD + "/" + N_HOTPENABLED, 0);
        digester.addCallParam("*/" + N_SYSTEM + "/" + N_ONETIMEPASSWORD + "/" + N_TOTPENABLED, 1);
        digester.addCallParam("*/" + N_SYSTEM + "/" + N_ONETIMEPASSWORD + "/" + N_OTCENABLED, 2);

        digester.addCallParam("*/" + N_SYSTEM + "/" + N_ONETIMEPASSWORD + "/" + N_HOTPDIGITS, 3);
        digester.addCallParam("*/" + N_SYSTEM + "/" + N_ONETIMEPASSWORD + "/" + N_TOTPDIGITS, 4);
        digester.addCallParam("*/" + N_SYSTEM + "/" + N_ONETIMEPASSWORD + "/" + N_TOTPDURATION, 5);
        digester.addCallParam("*/" + N_SYSTEM + "/" + N_ONETIMEPASSWORD + "/" + N_HOTPVALIDTIME, 6);
        digester.addCallParam("*/" + N_SYSTEM + "/" + N_ONETIMEPASSWORD + "/" + N_TOTPLABEL, 7);
        digester.addCallParam("*/" + N_SYSTEM + "/" + N_ONETIMEPASSWORD + "/" + N_OTPTALGORITHM, 8);
        digester.addCallParam("*/" + N_SYSTEM + "/" + N_ONETIMEPASSWORD + "/" + N_SMSHOTPSENDENABLED, 9);
        digester.addCallParam("*/" + N_SYSTEM + "/" + N_ONETIMEPASSWORD + "/" + N_EMAILHOTPSENDENABLED, 10);
        digester.addCallParam("*/" + N_SYSTEM + "/" + N_ONETIMEPASSWORD + "/" + N_SMSENDPOINT, 11);        
        digester.addCallParam("*/" + N_SYSTEM + "/" + N_ONETIMEPASSWORD + "/" + N_RSAPUKTOKEN, 12);
        digester.addCallParam("*/" + N_SYSTEM + "/" + N_ONETIMEPASSWORD + "/" + N_RSAPRKTOKEN, 13);
        digester.addCallParam("*/" + N_SYSTEM + "/" + N_ONETIMEPASSWORD + "/" + N_RSAKEYEXTCHANNEL, 14);
        digester.addCallParam("*/" + N_SYSTEM + "/" + N_ONETIMEPASSWORD + "/" + N_TOKENDURATION, 15);
    ...
    public Element generateXml(Element parent) {
        ...
        // create <onetimepassword> node
        Element onetimepasswordElement = systemElement.addElement(N_ONETIMEPASSWORD);
        // create <hotp-enabled> subnode
        onetimepasswordElement.addElement(N_HOTPENABLED).addText("" + m_cmsTwoFactorLoginConfiguration.isHotpEnabled());
        // create <totp-enabled> subnode
        onetimepasswordElement.addElement(N_TOTPENABLED).addText("" + m_cmsTwoFactorLoginConfiguration.isTotpEnabled());
        // create <otc-enabled> subnode
        onetimepasswordElement.addElement(N_OTCENABLED).addText("" + m_cmsTwoFactorLoginConfiguration.isOtcEnabled());
        // create <hotp-digits> subnode
        onetimepasswordElement.addElement(N_HOTPDIGITS).addText("" + m_cmsTwoFactorLoginConfiguration.getHoptDigits());
        // create <hotp-digits> subnode
        onetimepasswordElement.addElement(N_TOTPDIGITS).addText("" + m_cmsTwoFactorLoginConfiguration.getToptDigits());
        // create <totp-duration> subnode
        onetimepasswordElement.addElement(N_TOTPDURATION).addText("" + m_cmsTwoFactorLoginConfiguration.getToptDuration());
        // create <hotp-validtime> subnode
        onetimepasswordElement.addElement(N_HOTPVALIDTIME).addText("" + m_cmsTwoFactorLoginConfiguration.getHoptValidTime());
        // create <totp-label> subnode
        onetimepasswordElement.addElement(N_TOTPLABEL).addText("" + m_cmsTwoFactorLoginConfiguration.getToptLabel());
        // create <otp-algorithm> subnode
        onetimepasswordElement.addElement(N_OTPTALGORITHM).addText("" + m_cmsTwoFactorLoginConfiguration.getOptAlgorithm());
        // create <sms-hotpsendenabled> subnode
        onetimepasswordElement.addElement(N_SMSHOTPSENDENABLED).addText("" + m_cmsTwoFactorLoginConfiguration.isSmsHotpSendEnabled());
        // create <email-hotpsendenabled> subnode
        onetimepasswordElement.addElement(N_EMAILHOTPSENDENABLED).addText("" + m_cmsTwoFactorLoginConfiguration.isEmailHotpSendEnabled());
        // create <sms-endpoint> subnode
        onetimepasswordElement.addElement(N_SMSENDPOINT).addText("" + m_cmsTwoFactorLoginConfiguration.getSmsEndpoint());

     // create <rsa-publickey-token> subnode
        onetimepasswordElement.addElement(N_RSAPUKTOKEN).addText("" + m_cmsTwoFactorLoginConfiguration.getRsaPuKToken());

     // create <rsa-privatekey-token> subnode
        onetimepasswordElement.addElement(N_RSAPRKTOKEN).addText("" + m_cmsTwoFactorLoginConfiguration.getRsaPrKToken());

        // create <rsa-key-channel> subnode
        onetimepasswordElement.addElement(N_RSAKEYEXTCHANNEL).addText("" + m_cmsTwoFactorLoginConfiguration.getRsaKeyExtChannel());

        // create <token-duration> subnode
        onetimepasswordElement.addElement(N_TOKENDURATION).addText("" + m_cmsTwoFactorLoginConfiguration.getTokenDuration());
        ...
        if (m_tokenEncryptationHandler != null) {
            Element tokenEncryptationHandlerElem = systemElement.addElement(N_TOKENENCRYPTATIONHANDLER);
            tokenEncryptationHandlerElem.addAttribute(A_CLASS, m_tokenEncryptationHandler);
        }
    ...
    public CmsTwoFactorLoginConfiguration getCmsTwoFactorLoginConfiguration() {
    	return m_cmsTwoFactorLoginConfiguration;
    }
    ...
    /**
     * Returns an instance of the configured token encryptation handler.<p>
     * 
     * @return an instance of the configured token encryptation handler
     */
    public I_CmsTokenEncryptationHandler getTokenEncryptationHandler() {

        if (CmsStringUtil.isEmptyOrWhitespaceOnly(m_tokenEncryptationHandler)) {
            return new CmsDefaultTokenEncryptationHandler();
        }
        try {
        	I_CmsTokenEncryptationHandler validationHandler = (I_CmsTokenEncryptationHandler)Class.forName(m_tokenEncryptationHandler).newInstance();
            if (LOG.isInfoEnabled()) {
                LOG.info(Messages.get().getBundle().key(
                    Messages.INIT_TOKENENCRYPTATION_HANDLER_CLASS_SUCCESS_1,
                    m_tokenEncryptationHandler));
            }
            return validationHandler;
        } catch (Throwable t) {
            LOG.error(Messages.get().getBundle().key(
                Messages.INIT_TOKENENCRYPTATION_HANDLER_CLASS_INVALID_1,
                m_tokenEncryptationHandler), t);
            return new CmsDefaultTokenEncryptationHandler();
        }
    }
    ...
    public void setCmsTwoFactorLoginConfiguration(
    	    String hotpEnabled,
    	    String totpEnabled,
    	    String otcpEnabled,
    	    String hotpDigits,
    	...
    	if (CmsLog.INIT.isInfoEnabled()) {
            CmsLog.INIT.info(Messages.get().getBundle().key(Messages.INIT_CHECKING_ONETIMEPASSWORD_0));
        }
    	
    	m_cmsTwoFactorLoginConfiguration = new CmsTwoFactorLoginConfiguration(
    			hotpEnabled,
        	    totpEnabled,
        	    otcpEnabled,
        	    hotpDigits,
    	...
    	if (CmsLog.INIT.isInfoEnabled()) {
            CmsLog.INIT.info(Messages.get().getBundle().key(
                Messages.INIT_HOTP_ENABLED_1,
                "" + m_cmsTwoFactorLoginConfiguration.isHotpEnabled()));

            CmsLog.INIT.info(Messages.get().getBundle().key(
                    Messages.INIT_TOTP_ENABLED_1,
                    "" + m_cmsTwoFactorLoginConfiguration.isTotpEnabled()));

            CmsLog.INIT.info(Messages.get().getBundle().key(
                    Messages.INIT_HOTP_DIGITS_1,
                    m_cmsTwoFactorLoginConfiguration.getHoptDigits()));

            CmsLog.INIT.info(Messages.get().getBundle().key(
                    Messages.INIT_TOTP_DIGITS_1,
                    m_cmsTwoFactorLoginConfiguration.getToptDigits()));

            CmsLog.INIT.info(Messages.get().getBundle().key(
                    Messages.INIT_TOTP_DURATION_1,
                    m_cmsTwoFactorLoginConfiguration.getToptDuration()));

            CmsLog.INIT.info(Messages.get().getBundle().key(
                    Messages.INIT_HOTP_VALIDTIME_1,
                    m_cmsTwoFactorLoginConfiguration.getHoptValidTime()));

            CmsLog.INIT.info(Messages.get().getBundle().key(
                    Messages.INIT_TOTP_LABEL_1,
                    m_cmsTwoFactorLoginConfiguration.getToptLabel()));

            CmsLog.INIT.info(Messages.get().getBundle().key(
                    Messages.INIT_OTP_ALGORITHM_1,
                    m_cmsTwoFactorLoginConfiguration.getOptAlgorithm()));

            CmsLog.INIT.info(Messages.get().getBundle().key(
                    Messages.INIT_HOTP_SMS_1,
                    "" + m_cmsTwoFactorLoginConfiguration.isSmsHotpSendEnabled()));
    	    
            CmsLog.INIT.info(Messages.get().getBundle().key(
                    Messages.INIT_HOTP_EMAIL_1,
                    "" + m_cmsTwoFactorLoginConfiguration.isEmailHotpSendEnabled()));
    
            CmsLog.INIT.info(Messages.get().getBundle().key(
                    Messages.INIT_SMS_ENDPOINT_1,
                    m_cmsTwoFactorLoginConfiguration.getSmsEndpoint()));

            CmsLog.INIT.info(Messages.get().getBundle().key(
                    Messages.INIT_SMS_TOKENDURATION_1,
                    m_cmsTwoFactorLoginConfiguration.getTokenDuration()));

            
            CmsLog.INIT.info(Messages.get().getBundle().key(Messages.INIT_CHECKING_ONETIMEPASSWORD_INITIALIZED_0));
        }
    }
     ...
     * @param validationHandlerClass the validation handler class to set.
     */
    public void setTokenEncryptationHandler(String tokenEncryptationHandlerClass) {

    	m_tokenEncryptationHandler = tokenEncryptationHandlerClass;
    }
