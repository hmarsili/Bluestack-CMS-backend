...
public class DataTransformationWidget extends A_CmsWidget {

    public DataTransformationWidget() {
     ...
     */
    public DataTransformationWidget(String configuration) {
    ...
    public I_CmsWidget newInstance() {
        ...
        return new DataTransformationWidget(getConfiguration());
    }
}
