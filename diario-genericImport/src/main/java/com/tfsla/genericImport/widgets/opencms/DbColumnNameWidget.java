...
public class DbColumnNameWidget extends A_CmsWidget {

    public DbColumnNameWidget() {
     ...
     */
    public DbColumnNameWidget(String configuration) {
    ...
    public I_CmsWidget newInstance() {
        ...
        return new DbColumnNameWidget(getConfiguration());
    }
