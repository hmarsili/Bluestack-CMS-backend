...
public class XmlContentElementWidget extends A_CmsWidget {

    public XmlContentElementWidget() {
     ...
     */
    public XmlContentElementWidget(String configuration) {
    ...
    public I_CmsWidget newInstance() {
        ...
        return new XmlContentElementWidget(getConfiguration());
    }
}
