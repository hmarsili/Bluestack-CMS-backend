...
import com.tfsla.genericImport.widgets.opencms.DbColumnNameWidget;

public class TfsDbColumnNameWidget extends A_TfsWidget implements I_TfsWidget  {
	...
	public String getWidgetHtml(CmsObject cms,
        ...
        result.append("<select class=\"chzn-select item-value DbColumnNameWidget\" ");
	...
	public List<String> getOpenCmsWidgetsClassName() {
		...
		widgets.add(DbColumnNameWidget.class.getName());
		return widgets;
	}
