 ...
 * @since 6.0.0
 */
public class CmsDocumentTypeAddList extends A_CmsEmbeddedListDialog {

    /** list action id constant. */
    public static final String LIST_ACTION_ADD_DOCTYPE = "aad";

    /** list action id constant. */
    public static final String LIST_ACTION_ADD_DOCTYPE2 = LIST_ACTION_ADD_DOCTYPE + "2";

    /** list action dummy id constant. */
    public static final String LIST_ACTION_NONE = "an";

    /** list column id constant. */
    public static final String LIST_COLUMN_ADD_DOCTYPE = "cad";
    ...
    /** list id constant. */
    public static final String LIST_ID = "lssisdta";

    /** list action id constant. */
    public static final String LIST_MACTION_ADD_DOCTYPE = "maad";

    /** The log object for this class. */
    private static final Log LOG = CmsLog.getLog(CmsDocumentTypeAddList.class);
     ...
     */
    public CmsDocumentTypeAddList(CmsJspActionElement jsp) {

        this(jsp, LIST_ID, Messages.get().container(Messages.GUI_LIST_DOCUMENTTYPES_AVAIL_NAME_0));
    }
     ...
     */
    public CmsDocumentTypeAddList(CmsJspActionElement jsp, String listId, CmsMessageContainer listName) {
     ...
     */
    public CmsDocumentTypeAddList(PageContext context, HttpServletRequest req, HttpServletResponse res) {
    ...
    /**
     * @see org.opencms.workplace.list.A_CmsListDialog#initWorkplaceRequestValues(org.opencms.workplace.CmsWorkplaceSettings, jakarta.servlet.http.HttpServletRequest)
     */
    @Override
    ...
    protected void setColumns(CmsListMetadata metadata) {
        ...
        addCol.setName(Messages.get().container(Messages.GUI_LIST_INDEXSOURCE_COL_ADD_DOCTYPE_NAME_0));
        addCol.setHelpText(Messages.get().container(Messages.GUI_LIST_INDEXSOURCE_COL_ADD_DOCTYPE_NAME_HELP_0));
        addCol.setWidth("20");
        ...
        addAction.setName(Messages.get().container(Messages.GUI_LIST_SEARCHINDEX_ACTION_ADD_DOCTYPE_NAME_0));
        addAction.setHelpText(Messages.get().container(Messages.GUI_LIST_INDEXSOURCE_COL_ADD_DOCTYPE_NAME_HELP_0));
        ...
        remAction2.setHelpText(Messages.get().container(Messages.GUI_LIST_INDEXSOURCE_COL_ADD_DOCTYPE_NAME_HELP_0));
    ...
    protected void setMultiActions(CmsListMetadata metadata) {
        ...
        addMultiAction.setName(Messages.get().container(Messages.GUI_LIST_SEARCHINDEX_MACTION_ADD_DOCTYPE_NAME_0));
        addMultiAction.setHelpText(Messages.get().container(
            Messages.GUI_LIST_SEARCHINDEX_MACTION_ADD_DOCTYPE_NAME_HELP_0));
    ...
    /**
     * Returns the systems configured document types that are not assigned 
     * to the current indexsource (those that may be added).<p> 
     * 
     * @return the systems configured document types that are not assigned 
     *         to the current indexsource (those that may be added)
     */
