 ...
 * @since 6.0.0 
 */
public class CmsListDemo13 extends A_CmsListDialog {
     ...
     */
    public CmsListDemo13(CmsJspActionElement jsp) {
     ...
     */
    public CmsListDemo13(PageContext context, HttpServletRequest req, HttpServletResponse res) {
    ...
    protected String customHtmlEnd() {
        ...
        dialogButtonsHtml(result, BUTTON_OK, "");
    ...
    protected String customHtmlStart() {
        ...
        StringBuffer result = new StringBuffer(512);
        result.append(dialogBlockStart("Demo block title")); // should be localizaed message
        result.append("some blah-blah:\n");
        result.append("nqfqfoi qwemofmfq qmwfomfq fqofepqo fqmpfoqe qdxmpdqwmqwp dqwpq  df; "
            + "kpqwef qp fdqpfqkm mxaoi    wcvm qc o;ewmv wvj wemv w    iomvwe     mv "
            + "ewoi;vmew vw eom evwm ew oim vew wv  iom oiew jom vewoim vwoim vwe vewoimvew     qjceeviwlkdk");
