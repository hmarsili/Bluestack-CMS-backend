 ...
 * @since 6.0.0 
 */
public class CmsListDemo1 extends A_CmsListDialog {
     ...
     */
    public CmsListDemo1(CmsJspActionElement jsp) {
     ...
     */
    public CmsListDemo1(PageContext context, HttpServletRequest req, HttpServletResponse res) {
    ...
    protected void setColumns(CmsListMetadata metadata) {
        ...
        lastLoginCol.setSorteable(false);
