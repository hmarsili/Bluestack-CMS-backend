...
/**
 * Widget que muestra un calendario donde la fecha no se puede poner manualmente.
 * @author vpode
 *
 */
public class TfsCalendarWidget extends A_CmsWidget {

    /** The log object for this class. */
    private static final Log LOG = CmsLog.getLog(TfsCalendarWidget.class);

    /**
     * Creates a new calendar widget.<p>
     */
    public TfsCalendarWidget() {
     ...
     */
    public TfsCalendarWidget(String configuration) {
    ...
    public static long getCalendarDate(CmsMessages messages, String dateString, boolean useTime) throws ParseException {
        ...
        dateFormat = TfsCalendarWidget.getCalendarJavaDateFormat(dateFormat);
    ...
    public static String getCalendarLocalizedTime(Locale locale, CmsMessages messages, long timestamp) {
        ...
        DateFormat df = new SimpleDateFormat(
        		TfsCalendarWidget.getCalendarJavaDateFormat(messages.key(org.opencms.workplace.Messages.GUI_CALENDAR_DATE_FORMAT_0)
                + " "
    ...
    public I_CmsWidget newInstance() {
        ...
        return new TfsCalendarWidget(getConfiguration());
    }
