...
public class TfsEditVimeoId extends CmsDialog {

    /** The dialog type.<p> */
    public static final String DIALOG_TYPE = "newvimeoid";

    /** Request parameter name for the link target.<p> */
    public static final String PARAM_VIMEOID = "vimeoid";

    /** Stores the value of the link target.<p> */
    private String m_paramVimeoId;
     ...
     */
    public TfsEditVimeoId(CmsJspActionElement jsp) {
     ...
     */
    public TfsEditVimeoId(PageContext context, HttpServletRequest req, HttpServletResponse res) {
    ...
    public void actionChangeIdTarget() throws JspException {
        ...
        try {
            ...
            editFile.setContents(getParamVimeoId().getBytes());
            getCms().writeFile(editFile);
            // close the dialog window
            actionCloseDialog();
        } catch (Throwable e) {
            // error changing link target, show error dialog
            setParamMessage(Messages.get().getBundle(getLocale()).key(Messages.ERR_CHANGE_VIMEO_ID_TARGET_0));
    ...
    public String getOldTargetValue() throws JspException {
        ...
        String linkTarget = "";
        if (CmsStringUtil.isEmpty(getParamVimeoId())) {
            ...
            try {
                ...
                setParamMessage(Messages.get().getBundle(getLocale()).key(
                    Messages.ERR_GET_VIMEO_ID_TARGET_1,
                    getParamResource()));
     ...
     */
    public String getParamVimeoId() {

        return m_paramVimeoId;
    }
     ...
     */
    public void setParamVimeoId(String vimeoid) {

    	m_paramVimeoId = vimeoid;
    }
