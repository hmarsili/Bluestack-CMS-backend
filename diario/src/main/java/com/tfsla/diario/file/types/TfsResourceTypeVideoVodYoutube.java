...
import com.tfsla.diario.loader.TfsYoutubePointerLoader;
...
import com.tfsla.diario.search.videoDataExtractor.TfsPointerIDExtractor;


public class TfsResourceTypeVideoVodYoutube extends A_CmsResourceType  implements I_TfsVideoDataExtractor {
    ...
    private static final int RESOURCE_TYPE_ID = 2006;

    /** The name of this resource type. */
    private static final String RESOURCE_TYPE_NAME = "videoVod-youtube";
    
    private static final I_TfsVideoDataExtractorProcess extractor = new TfsPointerIDExtractor();

	@Override
	public int getLoaderId() {
		
		return TfsYoutubePointerLoader.RESOURCE_LOADER_ID;
	}

    /**
     * Default constructor, used to initialize member variables.<p>
     */
    public TfsResourceTypeVideoVodYoutube() {
