...
import com.tfsla.diario.loader.TfsVimeoPointerLoader;
...
public class TfsResourceTypeVideoVimeoLink extends A_CmsResourceType  implements I_TfsVideoDataExtractor {
    ...
    private static final int RESOURCE_TYPE_ID = 2001;

    /** The name of this resource type. */
    private static final String RESOURCE_TYPE_NAME = "video-vimeo";
	...
	public int getLoaderId() {
		...
		return TfsVimeoPointerLoader.RESOURCE_LOADER_ID;
	}

    /**
     * Default constructor, used to initialize member variables.<p>
     */
    public TfsResourceTypeVideoVimeoLink() {
