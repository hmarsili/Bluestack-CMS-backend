...
public class TfsResourceTypeVideoLinkProcessing extends A_CmsResourceType implements I_TfsVideoDataExtractor {
    ...
    private static final int RESOURCE_TYPE_ID = 2094;

    /** The name of this resource type. */
    private static final String RESOURCE_TYPE_NAME = "video-processing";
     ...
     */
    public TfsResourceTypeVideoLinkProcessing() {
