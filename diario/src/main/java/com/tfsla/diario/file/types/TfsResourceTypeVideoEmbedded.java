...
public class TfsResourceTypeVideoEmbedded extends A_CmsResourceType implements I_TfsVideoDataExtractor {
    ...
    private static final int RESOURCE_TYPE_ID = 2002;

    /** The name of this resource type. */
    private static final String RESOURCE_TYPE_NAME = "video-embedded";
     ...
     */
    public TfsResourceTypeVideoEmbedded() {
