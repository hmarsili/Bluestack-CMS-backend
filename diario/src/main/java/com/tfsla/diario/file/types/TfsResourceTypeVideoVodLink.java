...
public class TfsResourceTypeVideoVodLink extends A_CmsResourceType implements I_TfsVideoDataExtractor {
    ...
    private static final int RESOURCE_TYPE_ID = 2008;

    /** The name of this resource type. */
    private static final String RESOURCE_TYPE_NAME = "videoVod-link";
     ...
     */
    public TfsResourceTypeVideoVodLink() {
