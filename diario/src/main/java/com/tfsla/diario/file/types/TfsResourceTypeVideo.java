...
import com.tfsla.diario.search.videoDataExtractor.TfsVfsIDExtractor;


public class TfsResourceTypeVideo extends A_CmsResourceType implements I_TfsVideoDataExtractor {
    ...
    private static final int RESOURCE_TYPE_ID = 1193;

    /** The name of this resource type. */
    private static final String RESOURCE_TYPE_NAME = "video";
    
    private static final I_TfsVideoDataExtractorProcess extractor = new TfsVfsIDExtractor();
