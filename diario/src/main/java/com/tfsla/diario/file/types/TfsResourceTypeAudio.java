...
public class TfsResourceTypeAudio extends A_CmsResourceType implements I_TfsVideoDataExtractor {
    ...
    private static final int RESOURCE_TYPE_ID = 1195;

    /** The name of this resource type. */
    private static final String RESOURCE_TYPE_NAME = "audio";
