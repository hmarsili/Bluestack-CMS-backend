...
public class TfsResourceTypeUploadProcessing extends A_CmsResourceType implements I_TfsVideoDataExtractor {
    ...
    private static final int RESOURCE_TYPE_ID = 2095;

    /** The name of this resource type. */
    private static final String RESOURCE_TYPE_NAME = "upload-processing";
     ...
     */
    public TfsResourceTypeUploadProcessing() {
