...
/**
 * Widget que muestra un combo con los publisher de Twitter disponibles
 * @author Victor Podberezski
 *
 */
public class TwitterPublishersComboWidget extends A_CmsSelectWidget {


    /**
     * Creates a new select widget.<p>
     */
    public TwitterPublishersComboWidget() {
     ...
     */
    public TwitterPublishersComboWidget(List configuration) {
     ...
     */
    public TwitterPublishersComboWidget(String configuration) {
    ...
    public String getDialogWidget(CmsObject cms, I_CmsWidgetDialog widgetDialog, I_CmsWidgetParameter param) {
        ...
        try {
        	List<TwitterAccountPublisher> publishers = TwitterService.getInstance().getPublishers(cms);
        	String selected = getSelectedValue(cms, param);
        	for (Iterator iter = publishers.iterator(); iter.hasNext();) {
        		TwitterAccountPublisher publisher = (TwitterAccountPublisher) iter.next();
    ...
    public I_CmsWidget newInstance() {
        ...
        return new TwitterPublishersComboWidget(getConfiguration());
    }
