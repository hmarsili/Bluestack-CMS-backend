...
public class FacebookPublishersComboWidget extends A_CmsSelectWidget {


    /**
     * Creates a new select widget.<p>
     */
    public FacebookPublishersComboWidget() {
     ...
     */
    public FacebookPublishersComboWidget(List configuration) {
     ...
     */
    public FacebookPublishersComboWidget(String configuration) {
    ...
    public String getDialogWidget(CmsObject cms, I_CmsWidgetDialog widgetDialog, I_CmsWidgetParameter param) {
        ...
        try {
        	List<FacebookAccountPublisher> publishers = FacebookService.getInstance().getPublishers(cms);
        	String selected = getSelectedValue(cms, param);
        	for (Iterator iter = publishers.iterator(); iter.hasNext();) {
        		FacebookAccountPublisher publisher = (FacebookAccountPublisher) iter.next();
    ...
    public I_CmsWidget newInstance() {
        ...
        return new FacebookPublishersComboWidget(getConfiguration());
    }
