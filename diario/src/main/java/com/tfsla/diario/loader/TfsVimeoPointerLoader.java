...
/**
 * Loader for "video-vimeo" to videos in vimeo.<p>
 *
 * @author  Víctor Podberezski 
 * 
 */
public class TfsVimeoPointerLoader extends CmsDumpLoader {

    /** The id of this loader. */
    public static final int RESOURCE_LOADER_ID = 2001;
    ...
    private static String VIMEO_URL_PREFIX = "http://www.vimeo.com/";
    /**
     * The constructor of the class is empty and does nothing.<p>
     */
    public TfsVimeoPointerLoader() {
    ...
    throws IOException, CmsException {
        ...
        pointer = VIMEO_URL_PREFIX + pointer;
