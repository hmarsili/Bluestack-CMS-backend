...
public class GoogleAnalitysService extends A_SearchConsoleService {

	
	private static final Log LOG = CmsLog.getLog(GoogleAnalitysService.class);
	...
	public GoogleAnalitysService(PageContext page, HttpServletRequest request, HttpServletResponse response) {
		super();
	...
	public void initializeContext() throws Exception {
		...
		DATA_STORE_DIR = new java.io.File(OpenCms.getSystemInfo().getWebInfRfsPath(), "google-analytics-credentials-" + publication);
	...
	public void initializeContext(String path) throws Exception {
		...
		DATA_STORE_DIR = new java.io.File(OpenCms.getSystemInfo().getWebInfRfsPath(), "google-analytics-credentials-" + publicacion.getId());
    ...
    private  static  String OAUTH_SCOPE[]
            = new String[] { "https://www.googleapis.com/auth/analytics", 
        ...
        protected GoogleAuthorizationCodeFlow createFlow() throws IOException {
        	// Load client secrets.
            InputStream in =
            		GoogleAnalitysService.class.getResourceAsStream(clientSecret);
        ...
        protected String getRedirectUri(HttpServletRequest request) throws ServletException, IOException {
            ...
            url.setRawPath("/system/modules/com.tfsla.diario.webservices/news/analytics/login");
