...
public class MasRecomendadosCollectors extends A_ServerStatisticsCollector {

	public List getCollectorNames() {
		List<String> nombres = new ArrayList<String>();
		nombres.add("CollectorMasRecomendados");
		return nombres;
	...
	public List getResults(CmsObject cms, String collectorName, String param) throws CmsDataAccessException, CmsException {
		...
		TfsStatisticsOptions options = getOptions(TfsStatisticsOptions.RANK_RECOMENDACION);
