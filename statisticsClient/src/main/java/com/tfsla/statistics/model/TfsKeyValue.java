 ...
 */
            ...
            /**
            *  TfsKeyValue bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class TfsKeyValue
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
				...
				public String toString() {
					return "TfsKeyValue [localKey=" + localKey
    ...
    public static class Factory{
        ...
        */
        public static TfsKeyValue parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            TfsKeyValue object =
                new TfsKeyValue();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"TfsKeyValue".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (TfsKeyValue)com.tfsla.statistics.model.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://model.statistics.tfsla.com/xsd","key").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://model.statistics.tfsla.com/xsd","value").equals(reader.getName())){
	...
	public int hashCode() {
		...
		int result = 1;
		result = prime * result
				+ ((localKey == null) ? 0 : localKey.hashCode());
		result = prime * result
				+ ((localValue == null) ? 0 : localValue.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TfsKeyValue other = (TfsKeyValue) obj;
		if (localKey == null) {
			if (other.localKey != null)
				return false;
		} else if (!localKey.equals(other.localKey))
			return false;
		if (localValue == null) {
			if (other.localValue != null)
				return false;
		} else if (!localValue.equals(other.localValue))
			return false;
		return true;
	}
