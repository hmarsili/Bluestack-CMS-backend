...
public class CmsCachePropertyDefinitions
extends A_CmsCacheInstance {
    public static final CmsVfsCacheInstanceType TYPE = CmsVfsCacheInstanceType.VFS_PROPERTYDEFINITIONS;

    public CmsCachePropertyDefinitions() {
        super(TYPE);
    }
}
