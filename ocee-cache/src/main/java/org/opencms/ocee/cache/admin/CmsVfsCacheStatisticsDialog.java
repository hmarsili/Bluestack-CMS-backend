 ...
 */
public class CmsVfsCacheStatisticsDialog
extends A_CmsCacheStatisticsDialog {
    public CmsVfsCacheStatisticsDialog(CmsJspActionElement jsp) {
        super(jsp);
    }

    public CmsVfsCacheStatisticsDialog(PageContext context, HttpServletRequest req, HttpServletResponse res) {
