...
public class TfsEncuestaFechaCreacionTag  extends A_TfsEncuestaValueTag {


	/**
	 * 
	 */
	private static final long serialVersionUID = -5660209749448207701L;
    		...
    		if (encuesta!=null)
    		{
    			...
    			if (poll!=null)
    			{
    		        ...
    		        if(type.equals("descriptive")){
    		           Date uModif = new Date(Long.parseLong(poll.getFechaCreacion()));	
