...
public class TfsTriviaQuestionOptionImageTag  extends A_TfsTriviaCollectionValue {
    ...
    public TfsTriviaQuestionOptionImageTag() {
    ...
    public int doStartTag() throws JspException {
		...
		try {
			...
			setKeyName(TfsXmlContentNameProvider.getInstance().getTagName("trivia.questions.option.image"));
