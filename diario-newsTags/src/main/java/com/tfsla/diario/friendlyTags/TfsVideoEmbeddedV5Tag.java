...
public class TfsVideoEmbeddedV5Tag extends A_TfsNoticiaCollectionWithBlanks  {
	...
	public int doStartTag() throws JspException {
		...
		init(TfsXmlContentNameProvider.getInstance().getTagName("news.videoembedded")); //videoEmbedded
	...
	protected boolean hasMoreContent() {
		...
		while (index<=lastElement && !withElement) {
			...
			String controlValue = getIndexElementValue(noticia,keyControlName,index);
    ...
    {   	
        ...
        String videoType = "video-embedded";
