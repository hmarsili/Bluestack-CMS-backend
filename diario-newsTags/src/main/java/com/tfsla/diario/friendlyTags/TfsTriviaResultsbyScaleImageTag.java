...
public class TfsTriviaResultsbyScaleImageTag  extends A_TfsTriviaCollectionValue {
    ...
    public TfsTriviaResultsbyScaleImageTag() {
    ...
    public int doStartTag() throws JspException {
		...
		try {
			...
			setKeyName(TfsXmlContentNameProvider.getInstance().getTagName("trivia.resultsbyscale.image"));
