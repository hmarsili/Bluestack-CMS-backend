...
public class TfsTriviaUserResolutionDateTag extends A_TfsTriviaUserValueTag {

	private static final long serialVersionUID = -7545254296961257415L;

	protected static final Log LOG = CmsLog.getLog(TfsTriviaUserResolutionDateTag.class);
	...
	public int doStartTag() throws JspException {
		...
		if(trivia.getResultDate()==null)
		{
			...
			try {
		        Date dStart = trivia.getResultDate();
