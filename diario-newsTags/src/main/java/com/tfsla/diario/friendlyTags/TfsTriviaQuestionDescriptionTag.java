...
public class TfsTriviaQuestionDescriptionTag  extends A_TfsTriviaCollectionValue {
	...
	@Override
	 public int doStartTag() throws JspException {
		 ...
		 setKeyName(TfsXmlContentNameProvider.getInstance().getTagName("trivia.questions.description"));
