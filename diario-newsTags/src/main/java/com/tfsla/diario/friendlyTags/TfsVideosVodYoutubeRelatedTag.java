...
public class TfsVideosVodYoutubeRelatedTag <TfsVideosYoutube> extends A_TfsNoticiaCollectionWithBlanks  {
	...
	public int doStartTag() throws JspException {		
		...
		init(TfsXmlContentNameProvider.getInstance().getTagName("news.vod.youTube"));
    ...
    protected void exposeVideo(I_TfsNoticia noticia) throws CmsXmlException {   	
        ...
        String videoType = "videoVod-youtube";
