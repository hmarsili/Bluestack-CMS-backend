...
public class TfsFechaCreacionImagenTag  extends A_TfsNoticiaCollectionValue {
	...
	@Override
	 public int doStartTag() throws JspException {
	     ...
	     setKeyName("creationDate");

	     String dateLong = collection.getCollectionValue("creationDate"); 
