...
public class TfsFirstPublishDateTag extends A_TfsNoticiaValue {
	...
	public int doStartTag() throws JspException {
		...
		if(resource.getState().equals(CmsResource.STATE_NEW)) {
			...
			String dateStr = getPropertyValue(noticia,"firstPublishDate",false); 
			...
			if(dateStr!=null && !dateStr.equals(""))
			{
				...
				String dateLongStr = getElementValue(noticia,TfsXmlContentNameProvider.getInstance().getTagName("news.lastmodification")); //ultimaModificacion
		    ...
		    try {
		        ...
		        if(type.equals("descriptive")){
		           ...
		           String date = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss").format(firstPublishDate);
		           content = getDescriptiveDate(date);
			        ...
			        content = sdf.format(firstPublishDate);
		        }
