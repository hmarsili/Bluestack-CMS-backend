...
public class TfsTriviaResultsbyClassificationNameTag  extends A_TfsTriviaCollectionValue {
	...
	@Override
	 public int doStartTag() throws JspException {
		 ...
		 setKeyName(TfsXmlContentNameProvider.getInstance().getTagName("trivia.resultsbyclassification.name"));
