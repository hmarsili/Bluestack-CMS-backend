...
public class  TfsTiempoPreparacionTag extends A_TfsNoticiaValue {
    ...
    public int doStartTag() throws JspException {
        ...
        String content = getElementValue(noticia,TfsXmlContentNameProvider.getInstance().getTagName("news.recipe.tiempoPreparacion")); 
