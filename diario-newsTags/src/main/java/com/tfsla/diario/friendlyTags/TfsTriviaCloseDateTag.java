...
public class TfsTriviaCloseDateTag extends A_TfsTriviaValueTag {
	...
	protected static final Log LOG = CmsLog.getLog(TfsTriviaCloseDateTag.class);
	...
	public int doStartTag() throws JspException {
		...
		String dateLong = getPropertyValue(trivia,TfsXmlContentNameProvider.getInstance().getTagName("trivia.closeDate"),false);
		...
		if(dateLong==null || (dateLong !=null && (dateLong.equals("") || dateLong.equals("0"))))
		{
			...
			try {
		        Date dClose = new Date(Long.parseLong(dateLong));
		        ...
		        if(type.equals("descriptive")){
		           ...
		           String date = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss").format(dClose);
		    ...
		    {
		    	LOG.debug("Error en nt de fecha de cierre de trivias: "+ex.getMessage());
		    }
		}
