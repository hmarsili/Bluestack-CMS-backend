...
public class TfsTriviaImageTag extends A_TfsTriviaValueTag {
    ...
    public int doStartTag() throws JspException {
		...
		try {
			...
			String imagen = getElementValue(trivia,TfsXmlContentNameProvider.getInstance().getTagName("trivia.image"));
