...
public class TfsUltimaModificacionTag extends A_TfsNoticiaValue {
	...
	protected static final Log LOG = CmsLog.getLog(TfsUltimaModificacionTag.class);
	...
	public int doStartTag() throws JspException {
		...
		String dateLong = getPropertyValue(noticia,TfsXmlContentNameProvider.getInstance().getTagName("news.lastmodification"),false); //ultimaModificacion
	    try {
	    ...
	    {
	    	LOG.debug("Error en nt de fecha de ultima modificacion: "+ex.getMessage());
	    }
