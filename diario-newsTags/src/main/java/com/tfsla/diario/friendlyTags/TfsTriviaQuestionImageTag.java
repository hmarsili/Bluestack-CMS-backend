...
public class TfsTriviaQuestionImageTag  extends A_TfsTriviaCollectionValue {
    ...
    public TfsTriviaQuestionImageTag() {
    ...
    public int doStartTag() throws JspException {
		...
		try {
			...
			setKeyName(TfsXmlContentNameProvider.getInstance().getTagName("trivia.questions.image"));
