...
public class TfsUrlFrienlyVODLinkTag extends A_TfsNoticiaValue {
    ...
    public int doStartTag() throws JspException {
        ...
        boolean publicUrlBoolean = Boolean.parseBoolean(publicUrl);
     	//String content = UrlLinkHelper.getUrlFriendlyVODLink(evento.getXmlDocument().getFile(), cms, this.pageContext.getRequest(),relativeBoolean , publicUrlBoolean );
