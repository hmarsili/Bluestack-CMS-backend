...
public class TfsEncuestaFechaDespublicacionTag extends A_TfsEncuestaValueTag {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8464989844458634362L;
    		...
    		if (encuesta!=null)
    		{
    			...
    			if (poll!=null)
    			{
    		        ...
    		        if(type.equals("descriptive")){
    		        	if(poll.getFechaDespublicacion() != null && !poll.getFechaDespublicacion().equals("0")){
	    		           Date uModif = new Date(Long.parseLong(poll.getFechaDespublicacion()));	
