...
public class TfsFechaEventoDesdeTag  extends A_TfsNoticiaValue {
	...
	@Override
	 public int doStartTag() throws JspException {
	        ...
	        String dateLong = getElementValue(noticia,TfsXmlContentNameProvider.getInstance().getTagName("news.event.startDate")); 
