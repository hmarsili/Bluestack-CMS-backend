...
public class TfsVideosFlashV5Tag extends A_TfsNoticiaCollectionWithBlanks{
	...
	public int doStartTag() throws JspException {
		...
		init(TfsXmlContentNameProvider.getInstance().getTagName("news.videoflash")); //videoFlash
