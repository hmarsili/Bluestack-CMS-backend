...
public class TfsLiveBlogCoordinateXTag  extends A_TfsNoticiaCollectionValue {
	...
	@Override
	 public int doStartTag() throws JspException {
		 ...
		 setKeyName(TfsXmlContentNameProvider.getInstance().getTagName("news.liveblog.coordinateX"));
