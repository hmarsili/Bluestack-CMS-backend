...
public class OrderDirective extends A_OrderDirective {
	...
	public static final OrderDirective ORDER_BY_RELEVANCE = new  OrderDirective("relevance","relevance","relevance","",TYPE_INTEGER,true);
	public static final OrderDirective ORDER_BY_PRIORITY = new  OrderDirective("priority","home.priority","hightraffic","",TYPE_INTEGER,true);	
	public static final OrderDirective ORDER_BY_PRIORITY_SECTION = new  OrderDirective("priority-section","section.priority","hightraffic","",TYPE_INTEGER,true);	
	public static final OrderDirective ORDER_BY_CREATIONDATE  = new  OrderDirective("creation-date","","created","",TYPE_STRING,false);
	public static final OrderDirective ORDER_BY_USERMODIFICATIONDATE  = new  OrderDirective("user-modification-date","ultimaModificacion","ultimaModificacion","",TYPE_LONG,false);
	...
	public static final OrderDirective ORDER_BY_SECTION  = new  OrderDirective("section","seccion","seccion","seccion",TYPE_STRING,true);
	public static final OrderDirective ORDER_BY_ZONE  = new  OrderDirective("zone","section.zone","hightraffic","",TYPE_STRING,true);
	...
	static {
		availableOrders.add(ORDER_BY_PRIORITY);
		availableOrders.add(ORDER_BY_CREATIONDATE);
		availableOrders.add(ORDER_BY_USERMODIFICATIONDATE);
		...
		availableOrders.add(ORDER_BY_SECTION);
