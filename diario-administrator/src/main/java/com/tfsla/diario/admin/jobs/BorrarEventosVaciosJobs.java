...
public class BorrarEventosVaciosJobs implements I_CmsScheduledJob {

	private String resultados = "";
	private boolean doit = true;
	protected static final Log LOG = CmsLog.getLog(BorrarEventosVaciosJobs.class);
	...
	public String launch(CmsObject cms, Map parameters) throws Exception {
		...
		resultados += "Lanzando eliminacion de eventos  vacias entre los ultimos " + daysAfter + " y " + daysBefore + " dias\n";
		...
		for (int j=daysAfter;j<=daysBefore;j++) {
			...
			if (cms.existsResource(eventFolder))
				resuourcesToPublish.addAll(borrarEventosVacios(cms,eventFolder));
	...
	public List<CmsFile> borrarEventosVacios(CmsObject cmsObject, String pathFolder) throws CmsException {
