...
public class TfsQuantityUnityWidget extends A_CmsWidget {

    public TfsQuantityUnityWidget() {
     ...
     */
    public TfsQuantityUnityWidget(String configuration) {
    ...
    public I_CmsWidget newInstance() {
        ...
        return new TfsQuantityUnityWidget(getConfiguration());
    }
}
