...
public class TfsPatternedFieldWidget extends A_CmsWidget {

    public TfsPatternedFieldWidget() {
     ...
     */
    public TfsPatternedFieldWidget(String configuration) {
    ...
    public I_CmsWidget newInstance() {
        ...
        return new TfsPatternedFieldWidget(getConfiguration());
    }
}
