...
public class TfsFocalPointWidget extends A_CmsWidget {

    public TfsFocalPointWidget() {
     ...
     */
    public TfsFocalPointWidget(String configuration) {
    ...
    public I_CmsWidget newInstance() {
        ...
        return new TfsFocalPointWidget(getConfiguration());
    }
}
