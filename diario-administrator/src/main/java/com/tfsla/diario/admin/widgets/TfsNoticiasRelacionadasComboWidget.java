...
public class TfsNoticiasRelacionadasComboWidget extends A_TfsWidget implements I_TfsWidget {
	...
	public List<String> getOpenCmsWidgetsClassName() {
		...
		widgets.add(com.tfsla.diario.admin.widgets.opencms.TfsNoticiasRelacionadasComboWidget.class.getName());
		return widgets;
	}
