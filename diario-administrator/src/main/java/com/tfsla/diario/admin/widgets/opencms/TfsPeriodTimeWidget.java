...
public class TfsPeriodTimeWidget extends A_CmsWidget {

    public TfsPeriodTimeWidget() {
     ...
     */
    public TfsPeriodTimeWidget(String configuration) {
    ...
    public I_CmsWidget newInstance() {
        ...
        return new TfsPeriodTimeWidget(getConfiguration());
    }
}
