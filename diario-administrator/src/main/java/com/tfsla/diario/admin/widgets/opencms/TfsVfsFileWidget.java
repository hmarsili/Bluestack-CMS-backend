...
public class TfsVfsFileWidget extends A_CmsWidget {
    ...
    /** Configuration parameter to set start site of the popup resource tree. */
    public static final String CONFIGURATION_HIDEFIELD = "hideOnEmpty";
     ...
     */
    public TfsVfsFileWidget(boolean showSiteSelector, String startSite) {
     ...
     */
    public TfsVfsFileWidget(boolean showSiteSelector, String startSite, boolean includeFiles) {
     ...
     */
    public TfsVfsFileWidget(boolean showSiteSelector, String startSite, boolean includeFiles, boolean projectAware) {
     ...
     */
    public TfsVfsFileWidget(String configuration) {
    ...
    public String getConfiguration() {
        ...
        result.append("|");
        result.append(CONFIGURATION_HIDEFIELD);
        if (m_hideOnEmpty) {
            result.append("=true");
        } else {
            result.append("=false");
    ...
    public I_CmsWidget newInstance() {
        ...
        return new TfsVfsFileWidget(getConfiguration());
    }
    ...
    public void setConfiguration(String configuration) {
        ...
        if (CmsStringUtil.isNotEmptyOrWhitespaceOnly(configuration)) {
            ...
            int hideIndex = configuration.indexOf(CONFIGURATION_HIDEFIELD);
            if (hideIndex != -1) {
                // start site is given
                String hideValue = configuration.substring(CONFIGURATION_HIDEFIELD.length() + 1);
                if (hideValue.indexOf('|') != -1) {
                    // cut eventual following configuration values
                	hideValue = hideValue.substring(0, hideValue.indexOf('|'));
                }
                m_hideOnEmpty = hideValue.toLowerCase().equals("true") || hideValue.toLowerCase().equals("yes");
            }
